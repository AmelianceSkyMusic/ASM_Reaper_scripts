--[[
 * ReaScript Name: ASM [ITEM] Duplicate items relative grid (super smart 4-4 or 3-4)
...
script_title = "ASM [ITEM] Duplicate items relative grid (super smart 4-4 or 3-4)"
