--[[
 * ReaScript Name: ASM [TRACK] FX (except VSTi) unbypass selected tracks
 ...
 * REAPER: 5.0
 * Version: 1.0.0
 * Description: FX (except VSTi) unbypass selected tracks
--]]
...
script_title = "ASM [TRACK] FX (except VSTi) unbypass selected tracks"
