--[[
 * ReaScript Name: ASM [TRACK] Toggle FX (VSTi only) offline/online on selected tracks
 ...
 * REAPER: 5.0
 * Version: 1.0.0
 * Description: Toggle FX (VSTi only) offline/online on selected tracks
--]]
...
script_title = "ASM [TRACK] Toggle FX (VSTi only) offline/online on selected tracks"
