--[[
 * ReaScript Name: ASM [TRACK] FX (except VSTi) online on selected tracks
 ...
 * REAPER: 5.0
 * Version: 1.0.0
 * Description: FX (except VSTi) online on selected tracks
--]]
...
script_title = "ASM [TRACK] FX (except VSTi) online on selected tracks"
