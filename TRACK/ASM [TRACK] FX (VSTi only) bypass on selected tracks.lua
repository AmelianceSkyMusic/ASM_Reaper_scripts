--[[
 * ReaScript Name: ASM [TRACK] FX (VSTi only) bypass on selected tracks
 ...
 * REAPER: 5.0
 * Version: 1.0.0
 * Description: FX (VSTi only) bypass on selected tracks
--]]
...
script_title = "ASM [TRACK] FX (VSTi only) bypass on selected tracks"
