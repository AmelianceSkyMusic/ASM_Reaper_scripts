--[[
 * ReaScript Name: Script: FX (except VSTi) bypass on selected tracks
 ...
 * REAPER: 5.0
 * Version: 1.0.0
 * Description: FX (except VSTi) bypass on selected tracks
--]]
...
script_title = "ASM [TRACK] FX (except VSTi) bypass on selected tracks"
