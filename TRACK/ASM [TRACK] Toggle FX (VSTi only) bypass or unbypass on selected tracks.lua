--[[
 * ReaScript Name: ASM [TRACK] Toggle FX (VSTi only) bypass/unbypass on selected tracks
 ...
 * REAPER: 5.0
 * Version: 1.0.0
 * Description: Toggle FX (VSTi only) bypass/unbypasson selected tracks
--]]
...
script_title = "ASM [TRACK] Toggle FX (VSTi only) bypass/unbypass on selected tracks"
