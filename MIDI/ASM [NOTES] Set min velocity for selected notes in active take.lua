--[[
 * ReaScript Name: ASM [NOTES] Set min velocity for selected notes in active take
 ...
 * REAPER: 5.0
 * Version: 1.0
 * Description: Set min velocity for selected notes in active take
--]]
...
script_title = "ASM [NOTES] Set min velocity for selected notes in active take"
...
----------------------CHEKERS-----------------------
----------------------------------------------------
function cheker_nothing() end function cheker_error() reaper.defer(cheker_nothing) reaper.atexit(cheker_nothing) end
...
function main()
  ...
  for _ , i in pairs(count_tab) do
    ...
    new_vel = math.modf(roundFloatTo(tonumber(min_val), 0)) --convert and round value
