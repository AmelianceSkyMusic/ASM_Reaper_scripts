--[[
 * ReaScript Name: ASM [NOTES] Set max velocity for selected notes in active take
 ...
 * REAPER: 5.0
 * Version: 1.0
 * Description: Set max velocity for selected notes in active take
--]]
...
script_title = "ASM [NOTES] Set max velocity for selected notes in active take"
...
function main()
  ...
  for _ , i in pairs(count_tab) do
    ...
    new_vel = math.modf(roundFloatTo(tonumber(max_val), 0)) --convert and round value
