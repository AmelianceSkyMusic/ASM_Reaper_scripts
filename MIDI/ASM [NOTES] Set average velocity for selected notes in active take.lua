--[[
 * ReaScript Name: ASM [NOTES] Set average velocity for selected notes in active take
...
script_title = "ASM [NOTES] Set average velocity for selected notes in active take"
...
function main()
  ...
  for _ , i in pairs(count_tab) do
    ...
    new_vel = math.modf(roundFloatTo(tonumber(average_val), 0)) --convert and round value
