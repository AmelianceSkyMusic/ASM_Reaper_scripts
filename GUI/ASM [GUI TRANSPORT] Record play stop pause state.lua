...
'/ (num keyboard)\t- Repeat'..'\n'..
'\n'..
'You can change this keys in the scrip in "DEFAULT SETTINGS" part'..'\n'..
...
'\n'..
'Also you can change custom colors and texts in contect menu (MMB)'..'\n'..
'\n'..
'Feel free to open script and change "DEFAULT SETTINGS"'
...
local settings_file_check = asm_io.fileExists(settings_file_path)
if settings_file_check == false then
  ...
  settings_file = io.open (settings_file_path, 'r')    -- eneble repeat indication
      ...
      repeat_unique_color_state = tonumber(settings_file:read()) -- enable repeat uniqur color (below)
      repeat_on_color_state = tonumber(settings_file:read())     -- enable repeat ON uniqur color
      repeat_off_color_state = tonumber(settings_file:read())    -- enable repeat OFF uniqur color
      ...
      user_record_key_number = tonumber(settings_file:read()) -- * (num keyboard)
      user_repeat_key_number = tonumber(settings_file:read()) -- / (num keyboard)
      docker_start = tonumber(settings_file:read()) --start in docker
