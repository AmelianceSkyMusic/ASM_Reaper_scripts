...
local m = {}               --{ title='', state='', mute='', list='', endlist='', seperate='' },
  m[1]                  = { title='Repeat'}
  m[2]         = { title='Show indication'}
  m[3]               = { title='Edit text', list=1, seperate=3}
  m[4]                  = { title='STOP'}
  m[5]                 = { title='PAUSE'}
  m[6]                  = { title='PLAY'}
  m[7]                = { title='RECORD', endlist=1}
  m[8]         = { title='Edit text color', list=1}
  m[9]                 = { title='STOP'}
  m[10]                = { title='PAUSE'}
  m[11]                 = { title='PLAY'}
  m[12]               = { title='RECORD', endlist=1}
  m[13]   = { title='Edit background color', list=1}
  m[14]                 = { title='STOP'}
  m[15]                = { title='PAUSE'}
  m[16]                 = { title='PLAY'}
  m[17]               = { title='RECORD', endlist=1}
  m[18]      = { title='Show settings file', seperate=2}
  m[19]                    = { title='Help', seperate=2 }
  m[20]                   = { title='Close', seperate=2 }
